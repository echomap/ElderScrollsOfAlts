...
ElderScrollsOfAlts.view.guiTemplates = {  
  ...
  ["Research"] = {
    ...
    ["view"] = {
      ...
      [2] = "Note",
      [3] = "Clothing",
      [4] = "Clothier Research 1",
      [5] = "Clothier Research 2",
      [6] = "Clothier Research 3",
      [7] = "Blacksmithing",
      [8] = "Blacksmithing Research 1",
      [9] = "Blacksmithing Research 2",
      [10] = "Blacksmithing Research 3",
      [11] = "Woodworking",
      [12] = "Woodworking Research 1",
      [13] = "Woodworking Research 2",
      [14] = "Woodworking Research 3",
      [15] = "Jewelry",
